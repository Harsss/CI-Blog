...
<div class="container"> <h1 class="my-4"> Edit Article  </h1> 

<?php
echo form_open('Writer/UpdateArticle');
echo form_hidden("ArticleId",$Article->Id);
 ...
 ?> </div>
  ...
  <div class="form-group">
    ...
    <?php  $data2 = array(
        ...
        'value'         => set_value("Body",$Article->ArticleBody),
